...
- Oversized quadratic diffs: dense LCS, dense-compatible linear-space LCS, bounded exact low-edit band, bounded exact match-sparse LCS, then non-crossing anchors; never positional-fallback blame.
